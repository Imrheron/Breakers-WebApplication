<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Beginnerapp.aspx.cs" Inherits="WebApplication2.Beginnerapp" %>
...
<asp:Button ID="Button1" runat="server" OnClick="Button1_click" Text="lets start!" style="background-color:white; color:dodgerblue; border: 2px solid dodgerblue;" class="w3-button w3-left" />   

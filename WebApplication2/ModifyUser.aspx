        ...
        <div class="w3-container w3-padding-64 w3-theme-l5" id="edit">
            <div class="w3-row">
                ...
                <div class="w3-section">
                    ...
                    <br />
                    <asp:TextBox ID="txtusername" runat="server" Width="1288px" Height="27px" OnTextChanged="txtusername_TextChanged" AutoPostBack="true"></asp:TextBox>&nbsp;
                </div>
                <div class="w3-section">
                    <label><i class="fa fa-envelope-o w3-text-teal w3-xlarge"></i>Email</label>
                    <br />
                    <asp:TextBox ID="txtemail" runat="server" Width="1288px" Height="27px" OnTextChanged="txtemail_TextChanged" AutoPostBack="true"></asp:TextBox>&nbsp;
                </div>
                <div class="w3-section">
                    <label><i class="fa fa-lock w3-text-teal w3-xlarge"></i>Password</label>
                    <br />
                    <asp:TextBox ID="txtpassword" runat="server" Width="1288px" Height="27px" OnTextChanged="txtpassword_TextChanged" AutoPostBack="true"></asp:TextBox>&nbsp;
                </div>
                <div class="w3-section">
                    <label><i class="fa fa-check w3-text-teal w3-xlarge"></i>Confirm Password</label>
                    <br />
                    <asp:TextBox ID="txtpasswordconfirm" runat="server" Width="1288px" Height="27px"></asp:TextBox>&nbsp;
                </div>
            </div>
        </div>
